...
class form extends pfbc { 
	...
	public function __construct($id = "myform") {
		...
		$this->alphanumericErrorMsgFormat = "Errore: [LABEL] contains one or more invalid characters - only letters and/or numbers are allowed.";
		$this->captchaLang = "en";
		...
		$this->errorMsgFormat = "Error: [LABEL] &egrave; obbligatorio.";
