...
//include_once($basepath."/main_include.php");
 ...
 if($currentMese == 3 || $currentMese == 6 || $currentMese == 9 || $currentMese == 12) {
    ...
    echo $agenzia['Tot'];
                 ...
                 $r = $service->inviaFatturaAgenzia(0, $gestoreId, $nome, $indirizzo_via, $indirizzo_cap, $indirizzo_provincia, $indirizzo_citta,
