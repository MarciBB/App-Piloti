...
function loadMediazioneStep(modulo,page,elem)
    ...
    function submit_form_provvigione()
    {
        ...
        $.ajax({
           type: "POST",
           url: "/protected/modules/provvigione/provvigione_action.php",
           data: $("#application_form").serialize(),
           success: function(msg) {
                     avviso_operazione("ok");
                     if (step_successivo=='0')
                         loadMainContent('provvigione','provvigione.php',this);
                     else
                     loadMainContent('provvigione','provvigione.php?do=add&step='+step_successivo,this);
            } // end success
