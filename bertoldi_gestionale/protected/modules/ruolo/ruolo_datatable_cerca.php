		...
		<!--<script type="text/javascript" language="javascript" src="/DataTables/media/js/jquery.dataTables.js"></script>-->
			...
			$(document).ready(function() {
                            ...
                            oTable = $("#brain_datatables").dataTable({
                                    "bProcessing": true,
                                    "bServerSide": true,
                                    "sAjaxSource": "/protected/modules/ruolo/ruolo_processing_cerca.php",
                                    "aoColumns": [
                                    { "sClass": "center" },
                                    null,                                                                      
                                    null,
			...
			//"sInfoFiltered": "(risultati totali: _MAX_)"
                        ...
                        "aaSorting": [[2, 'asc']],
                            "fnInitComplete": function () {
                                      ...
                                      var bottone_aggiungi='<div class="brain_servicebar"><a class="brain_aggiungi" href="javascript:void(0);" onclick="loadMainContent(\'ruolo\',\'ruolo.php?do=add\',this);" title="Crea ruolo">aggiungi ruolo</a></div> ';                          
