                                 ...
                                 <div class="brain_colLeft">
                                    ...
                                    print("<br />");
                                     ...
                                     print("<br />");
                                      print("<br />");
                                     if ($FermataStato)
                                     print("<span class=\"operatore_attivo\">attiva</span>");
                                     else
                                     print("<span class=\"operatore_disattivo\">disattiva</span>");    
...
<form id="CambiaStatoMediazioneId">
    ...
    <? if ($GestoreStato){?><span class="operatore_attivo">Attivo</span><p>Nel caso in cui lo stato venga impostato su disattivo, l'accesso al sistema verra' disabilitato.</p><? } ?>
    <? if ($GestoreStato==0){?><span class="operatore_disattivo">Disattivo</span><p>Nel caso in cui lo stato venga impostato su attivo, verra' abilitato l'accesso al sistema.</p><? } ?>
