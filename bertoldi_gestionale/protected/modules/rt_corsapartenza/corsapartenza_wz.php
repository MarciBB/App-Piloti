...
$HtmlCommon->html_titolo_pagina("Elenco tratte");
$HtmlCommon->html_titolo_box("Elenco tratte");
$db= new Database();
$db->connect();
...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="brain_datatables">
    <thead>
        <tr class="brain_tabellaTr">
            <th width="5%">stato</th>
            <th width="20%">Tratta</th>
            <th width="10%">Tipo</th>
            <th width="10%">Mezzo</th>
            <th width="10%">Area</th>
            <th width="20%">Linea</th>
            <th width="20%">Percorso</th>
            <th width="5%">edita</th>
        </tr>
...
?>
			...
			<div class="brain_formModifica formGestoreEdita">
                             <h2><span class="brain_colorh2"><?=$tratta_wizard->DatiGenerali['TrattaNome']?> - </span>Elenco fermate</h2>
                       
                             <br />
                              <br />
                        <div class="GestoreSedeAdd">
                             <a class="brain_add" href="#" onclick="javascript:ExternalLoad('rt_fermata','fermata.php?do=add&TrattaId=<?=$TrattaId?>');" title="aggiungi fermata"><i class="fa fa-plus" aria-hidden="true"></i> aggiungi fermata</a>
                        </div>
                             ...
                             <!-- QUI L'ELENCO DELLE FERMATE -->
                                <tr class="rowBianca">
                                    ...
                                    ?>
                                         ...
                                         <td><a title="edita" onclick="javascript:ExternalLoad('rt_fermata','fermata.php?do=edit&amp;FermataId=<?=$FermataId?>');" href="#"><i class="fa fa-pencil-square-o edita" aria-hidden="true" alt="edita" title="edita"></i></a></td>
...
<form id="CambiaStatoMediazioneId">
    ...
    <? if ($GestoreStato){?><i class="fa fa-check-circle green" aria-hidden="true"></i> Attivo<p>Nel caso in cui lo stato venga impostato su disattivo, l'accesso al sistema verra' disabilitato.</p><? } ?>
    <? if ($GestoreStato==0){?><i class="fa fa-times-circle red" aria-hidden="true"></i> Disattivo<p>Nel caso in cui lo stato venga impostato su attivo, verra' abilitato l'accesso al sistema.</p><? } ?>
