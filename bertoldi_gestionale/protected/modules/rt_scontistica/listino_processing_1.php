	...
	while ( $aRow = $db->fetch_array( $rResult ) )
	{
		...
		for ( $i=0 ; $i<count($aColumns) ; $i++ )
		{
			...
			elseif ( $aColumns[$i] == "ListinoId")
			{
				...
				/* General output */
                                $row[] = "<a href=\"#\" onclick=\"loadMainContent('rt_listino','listino.php?do=edit&amp;ListinoId=".$ListinoId."',this);\" title=\"edita\"><img alt=\"edita\" title=\"edita\" src=/images/edita_item.png /></a>";
			}
