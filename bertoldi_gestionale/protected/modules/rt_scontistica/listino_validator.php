...
function loadMediazioneStep(modulo,page,elem)
    ...
    function submit_form_listino()
    {
        ...
        $.ajax({
           type: "POST",
           url: "/protected/modules/rt_scontistica/listino_action.php",
           ...
           success: function(msg) {
              ...
              if(msg.indexOf(',')>-1)
              {
                 ...
                 if (step_successivo=='0')
                      loadMainContent('rt_scontistica','listino.php?do=edit&IdListino=0',this);
                  else
                   loadMainContent1('rt_scontistica','listino.php?do=add&step='+step_successivo,this);
