...
if (isset($post_linea_id) and ($post_linea_id>0) )
    $swhere.="and RT_PrenotazionePercorso.LineaId=$post_linea_id ";
if (isset($post_corsa_id) and ($post_corsa_id>0) )
    $swhere.="and CorsaId=$post_corsa_id ";
...
sum(RT_Prenotazione.TotalePaxPrenotati) AS TotalePaxPrenotati,
...
WHERE  RT_Prenotazione.PrenotazioneStato = 4
...
$titolo_report=$dizionario['menu_voci']['30']."<small><a href='#' class='exportToExcel'>".$dizionario['stampe']['esporta']."</a></small><br />";
...
$(document).ready(function() {
	$(".exportToExcel").click(function(e){
		$(".report_excel").table2excel({
			exclude: ".noExl",
			name: "Statistiche Annullamento",
			filename: "statistiche_annullamento" + new Date().toISOString().replace(/[\-\:\.]/g, "") + ".xls",
			fileext: ".xls",
			exclude_img: true,
			exclude_links: true,
			exclude_inputs: true,
