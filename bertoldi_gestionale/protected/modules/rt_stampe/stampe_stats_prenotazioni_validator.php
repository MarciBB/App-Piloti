...
<script type="text/javascript"> 
        function getCorsaByLinea(oggetto)
{
      
     LineaId=$("#LineaId").val();
    
       
    page_to_load="/protected/modules/rt_stampe/get_corse_by_linea.php?do=getCorsaByLinea&LineaId="+LineaId;
            //	$("#layer_nero2").toggle();
...
<script type="text/javascript"> 
   ...
   $(document).ready(function() {
    ...
    function submit_form_statistiche()
    {
        ...
        $.ajax({
           type: "POST",
           url: "/protected/modules/rt_stampe/stampe_stats_prenotazioni_processing.php",
