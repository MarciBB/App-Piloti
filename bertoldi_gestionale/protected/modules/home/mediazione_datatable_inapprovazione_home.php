<style type="text/css" title="currentStyle">
		...
		<!--<script type="text/javascript" language="javascript" src="/DataTables/media/js/jquery.dataTables.js"></script>-->
			...
			$(document).ready(function() {
                            ...
                            /* Init the table */
                            oTable = $("#brain_datatables_inapprovazione").dataTable({
                                    "bProcessing": true,
                                    "bServerSide": true,
                                    "sAjaxSource": "/protected/modules/home/mediazione_processing_inapprovazione_home.php",
                                     "bInfo": false,
                                    "bPaginate": false,
			...
			//"sInfoFiltered": "(risultati totali: _MAX_)"
                 ...
                 $('#brain_datatables_inapprovazione tbody td a img.brain_collapse').live( 'click', function () {
