<style type="text/css" title="currentStyle">
		...
		<!--<script type="text/javascript" language="javascript" src="/DataTables/media/js/jquery.dataTables.js"></script>-->
			...
			$(document).ready(function() {
                            ...
                            /* Init the table */
                            oTable = $("#brain_datatables_inconferma").dataTable({
                                    "bProcessing": true,
                                    "bServerSide": true,
                                    "sAjaxSource": "/protected/modules/home/mediazione_processing_inconferma_home.php",
                                      "bInfo": false,
                                    "bPaginate": false,
                                     "aoColumns": [
			...
			//"sInfoFiltered": "(risultati totali: _MAX_)"
				...
				$('tbody tr').each(function(){
                 ...
                 $('#brain_datatables_inconferma tbody td a img.brain_collapse').live( 'click', function () {
