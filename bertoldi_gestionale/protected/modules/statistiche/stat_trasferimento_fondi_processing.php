...
$q="SELECT * from stat_TrasferimentoFondiPerGiornoFinal where  GestoreIdRef IN ($InGestoreFigli) and OdcIdRef=$user->OdcId and DataFattura>='$post_dal_format' and DataFattura<='$post_al_format'";
...
$q.="order by RagioneSociale,NumeroFattura asc";
...
$rep->AddField('NumeroFattura','Numero Fattura');
$rep->AddField('DataFattura_formattata','Data Fattura');
$rep->AddField('CodiceMediazione','Protocollo');
...
$rep->AddField('TotaleFattura','Totale',1,'','money');
...
$rep->SetSummary('<strong>TOTALE DA RICEVERE <strong> ');
...
$rep=new CReporTool();
$q_basic="SELECT
stat_TotaleTrasferimentoFondiPerGiorno.SedeIns AS SedeIns,
stat_TotaleTrasferimentoFondiPerGiorno.OdcIdRef AS OdcIdRef,
stat_TotaleTrasferimentoFondiPerGiorno.GestoreIdRef AS GestoreIdRef,
stat_TotaleTrasferimentoFondiPerGiorno.GestoreId AS GestoreId,
stat_TotaleTrasferimentoFondiPerGiorno.Indirizzo AS Indirizzo,
stat_TotaleTrasferimentoFondiPerGiorno.Comune AS Comune,
stat_TotaleTrasferimentoFondiPerGiorno.RagioneSociale AS RagioneSociale,
sum(`stat_TotaleTrasferimentoFondiPerGiorno`.`TotImponibile`) AS TotaleImponibile,
sum(`stat_TotaleTrasferimentoFondiPerGiorno`.`TotNonImponibile`) AS TotNonImponibile,
sum(`stat_TotaleTrasferimentoFondiPerGiorno`.`TotaleIva`) AS TotaleIva,
sum(`stat_TotaleTrasferimentoFondiPerGiorno`.`TotaleFattura`) AS TotaleFattura,
stat_TotaleTrasferimentoFondiPerGiorno.MeseFatturato AS MeseFatturato,
stat_TotaleTrasferimentoFondiPerGiorno.AnnoFatturato AS AnnoFatturato,
stat_TotaleTrasferimentoFondiPerGiorno.Odc AS Odc,
AppMese.AppMese
from (`stat_TotaleTrasferimentoFondiPerGiorno` join `AppMese` on((`stat_TotaleTrasferimentoFondiPerGiorno`.`MeseFatturato` = `AppMese`.`AppMeseId`))) ";
$q_group="group by `stat_TotaleTrasferimentoFondiPerGiorno`.`SedeIns`,`stat_TotaleTrasferimentoFondiPerGiorno`.`MeseFatturato`,`stat_TotaleTrasferimentoFondiPerGiorno`.`AnnoFatturato`,`stat_TotaleTrasferimentoFondiPerGiorno`.`OdcIdRef`,`stat_TotaleTrasferimentoFondiPerGiorno`.`GestoreIdRef`";

$q_where=" where  stat_TotaleTrasferimentoFondiPerGiorno.GestoreIdRef IN ($InGestoreFigli) and stat_TotaleTrasferimentoFondiPerGiorno.OdcIdRef=$user->OdcId and stat_TotaleTrasferimentoFondiPerGiorno.DataFattura>='$post_dal_format' and stat_TotaleTrasferimentoFondiPerGiorno.DataFattura<='$post_al_format'";
...
AppMese.AppMese
from (`stat_TotaleTrasferimentoFondiPerGiorno` join `AppMese` on((`stat_TotaleTrasferimentoFondiPerGiorno`.`MeseFatturato` = `AppMese`.`AppMeseId`))) ";
$q_group="group by `stat_TotaleTrasferimentoFondiPerGiorno`.`SedeIns`,`stat_TotaleTrasferimentoFondiPerGiorno`.`AnnoFatturato`,`stat_TotaleTrasferimentoFondiPerGiorno`.`OdcIdRef`,`stat_TotaleTrasferimentoFondiPerGiorno`.`GestoreIdRef`";
...
$titolo_report="Report degli Importi non ancora ricevuti ma incassati dalla sede secondaria<br </>";
