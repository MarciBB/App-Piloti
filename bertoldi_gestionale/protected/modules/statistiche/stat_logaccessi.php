...
include_once("stat_logaccessi_validator.php");  
...
<?
    $page->create_select($dizionario['gestore']['gestore'].":","GestoreId","GestoreId","rowForm",$arr_gestore,$gestorecorrente,"GestoreId","RagioneSociale",
    array("onChange"=>"'javascript:getSediByGestore(this);'"
                                                   ),1);
 
 
    $page->create_select($dizionario['generale']['sede'].":","SedeId","SedeId","rowForm",$arr_sedi,$user->SedeId,"SedeId","Sede",
                                             null,1);
