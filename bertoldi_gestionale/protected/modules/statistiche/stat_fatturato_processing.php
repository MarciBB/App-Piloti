...
$q="SELECT * from stat_FatturatoPerGiornoFinal where  GestoreIdRef IN ($InGestoreFigli) and OdcIdRef=$user->OdcId and DataFattura>='$post_dal_format' and DataFattura<='$post_al_format'";
...
$rep=new CReporTool();
$q_basic="SELECT
stat_TotaleFatturatoPerGiorno.SedeIns AS SedeIns,
stat_TotaleFatturatoPerGiorno.OdcIdRef AS OdcIdRef,
stat_TotaleFatturatoPerGiorno.GestoreIdRef AS GestoreIdRef,
stat_TotaleFatturatoPerGiorno.GestoreId AS GestoreId,
stat_TotaleFatturatoPerGiorno.Indirizzo AS Indirizzo,
stat_TotaleFatturatoPerGiorno.Comune AS Comune,
stat_TotaleFatturatoPerGiorno.RagioneSociale AS RagioneSociale,
sum(`stat_TotaleFatturatoPerGiorno`.`TotImponibile`) AS TotaleImponibile,
sum(`stat_TotaleFatturatoPerGiorno`.`TotNonImponibile`) AS TotNonImponibile,
sum(`stat_TotaleFatturatoPerGiorno`.`TotaleIva`) AS TotaleIva,
sum(`stat_TotaleFatturatoPerGiorno`.`TotaleFattura`) AS TotaleFattura,
stat_TotaleFatturatoPerGiorno.MeseFatturato AS MeseFatturato,
stat_TotaleFatturatoPerGiorno.AnnoFatturato AS AnnoFatturato,
stat_TotaleFatturatoPerGiorno.Odc AS Odc,
AppMese.AppMese
from (`stat_TotaleFatturatoPerGiorno` join `AppMese` on((`stat_TotaleFatturatoPerGiorno`.`MeseFatturato` = `AppMese`.`AppMeseId`))) ";
$q_group="group by `stat_TotaleFatturatoPerGiorno`.`SedeIns`,`stat_TotaleFatturatoPerGiorno`.`MeseFatturato`,`stat_TotaleFatturatoPerGiorno`.`AnnoFatturato`,`stat_TotaleFatturatoPerGiorno`.`OdcIdRef`,`stat_TotaleFatturatoPerGiorno`.`GestoreIdRef`";

$q_where=" where  stat_TotaleFatturatoPerGiorno.GestoreIdRef IN ($InGestoreFigli) and stat_TotaleFatturatoPerGiorno.OdcIdRef=$user->OdcId and stat_TotaleFatturatoPerGiorno.DataFattura>='$post_dal_format' and stat_TotaleFatturatoPerGiorno.DataFattura<='$post_al_format'";
...
AppMese.AppMese
from (`stat_TotaleFatturatoPerGiorno` join `AppMese` on((`stat_TotaleFatturatoPerGiorno`.`MeseFatturato` = `AppMese`.`AppMeseId`))) ";
$q_group="group by `stat_TotaleFatturatoPerGiorno`.`SedeIns`,`stat_TotaleFatturatoPerGiorno`.`AnnoFatturato`,`stat_TotaleFatturatoPerGiorno`.`OdcIdRef`,`stat_TotaleFatturatoPerGiorno`.`GestoreIdRef`";
...
$titolo_report="Report relativo al Fatturato<br </>";
