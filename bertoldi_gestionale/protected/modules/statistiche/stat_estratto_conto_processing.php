...
$q="SELECT * from estratto_contoPerGiornoFinal where  GestoreIdRef IN ($InGestoreFigli) and OdcIdRef=$user->OdcId and DataFattura>='$post_dal_format' and DataFattura<='$post_al_format'";
