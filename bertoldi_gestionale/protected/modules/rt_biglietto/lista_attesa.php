...
global $ModuloId;
$ModuloId=6;// modulo base mediazione
global $user;
...
$HtmlCommon->html_titolo_pagina($dizionario['biglietto']['titolo_lista_attesa'],0,"","");
$HtmlCommon->html_titolo_box($dizionario['biglietto']['titolo_lista_attesa']);
$db= new Database();
$db->connect();
...
include_once("biglietto_datatable_lista.php");
