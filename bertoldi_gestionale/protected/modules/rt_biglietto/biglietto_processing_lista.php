...
$sTable = "RT_ViewElencoPrenotazioneLista";
$OdcIdRef=$user->OdcId;
	...
	*/
    ...
    for ( $i=0 ; $i<count($aColumns) ; $i++ ) {
        if ( $aColumns[$i] == "PrenotazioneId") {
            ...
            $row[] = "<a href=\"#\" onclick=\"javascript:ConfermaPrenotazioneLista('$PrenotazioneId','$CodicePrenotazione');\" title=\"edita\"><i class=\"fa fa-refresh green\" aria-hidden=\"true\" alt=\"blocca\" title=\"blocca - sblocca\"></i></a>";
