...
if (strcmp ($res, "VERIFIED") == 0) {
	...
	$sql = "SELECT * FROM RT_Prenotazione WHERE Stato = 1 AND Cancella = 0 AND (PrenotazioneStato = 1 OR PrenotazioneStato = 11 OR (PrenotazioneStato = 3 AND TotaleResiduo > 0)) AND PrenotazioneId = $PrenotazioneId";
