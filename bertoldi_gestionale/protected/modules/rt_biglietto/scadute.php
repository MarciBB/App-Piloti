...
global $ModuloId;
$ModuloId=39; // modulo base mediazione
global $user;
...
function show_list()
{
	...
	$HtmlCommon->html_titolo_pagina($dizionario['biglietto']['titolo_non_partite'], 0, "", "");
	$HtmlCommon->html_titolo_box($dizionario['biglietto']['titolo_non_partite']);
	$db= new Database();
	$db->connect();

	include_once("biglietto_validator.php");           
	include_once("biglietto_datatable_scadute.php");
