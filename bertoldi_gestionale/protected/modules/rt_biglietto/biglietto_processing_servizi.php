...
$ModuloId=1;
$aColumns = array('StatoPrenotazione','RagioneSociale','CodicePrenotazione','Principale','NumeroBiglietto','Cliente','DataPartenza','OrarioPartenza','ComunePartenza','ComuneArrivo','TipoViaggio','Importo');
	...
	*/
	...
	for ( $i=0 ; $i<count($aColumns) ; $i++ )
	{
		...
		{     
			...
			if ($aColumns[$i] == 'Principale') {
				$temp = "`p`.`ClienteNome`";
			}
			
			if ($aColumns[$i] == 'CodicePrenotazione') {
				$temp = "`rdc`.`CodicePrenotazione`";
			}
