...
function show_list() {
	...
	include_once("biglietto_datatable_prenotati.php");
	...
	<a href="#" onclick="self.location.href = 'protected/modules/rt_biglietto/exportExcel.php?CorsaId=<?php echo $CorsaId;?>&DataCorsa=<?php echo $DataCorsa;?>&action=xls&Order=<?php echo $Order;?>'"><?=$dizionario['biglietto']['esporta_lista']?></a>
	<br/><br/> 
	<?=$dizionario['biglietto']['scegli_ordine']?><br/>
	<ul style="list-style-type: inherit; padding-left:20px;">
		<li><a href="#" onclick="ExternalLoad('rt_biglietto','prenotati_corsa.php?do=show_list&CorsaId=<?php echo $CorsaId;?>&DataCorsa=<?php echo $DataCorsa;?>&Order=0');"><?=$dizionario['biglietto']['ordina_partenza']?></a></li>
		<li><a href="#" onclick="ExternalLoad('rt_biglietto','prenotati_corsa.php?do=show_list&CorsaId=<?php echo $CorsaId;?>&DataCorsa=<?php echo $DataCorsa;?>&Order=1');"><?=$dizionario['biglietto']['ordina_arrivo']?></a></li>         
	</ul>
	<table cellpadding="0" cellspacing="0" border="0" class="display" id="brain_datatables">
		...
		<tbody>
			...
			<tr>
				<td colspan="14" class="dataTables_empty"><i class='fa fa-spinner grey-dark' aria-hidden='true'></i><br><?=$dizionario['generale']['caricamento_in_corso']?></td>
			</tr>
		</tbody>
