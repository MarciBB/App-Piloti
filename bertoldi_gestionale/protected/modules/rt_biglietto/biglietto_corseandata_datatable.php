        ...
        $.fn.dataTableExt.oApi.fnGetColumnData = function ( oSettings, iColumn, bUnique, bFiltered, bIgnoreEmpty ) {
			...
			$(document).ready(function() {                         
                            /* Init the table */
                              CorsaId='<?=$CorsaId?>';
                              DataCorsa='<?=$DataCorsa?>';
                              ComunePartenzaId='<?=$ComunePartenza?>';
                              ComuneDestinazioneId='<?=$ComuneArrivo?>';
                              DataFiltroA=$("#RicercaDaId").val();
                              DataFiltroR=$("#RicercaAId").val();
                              
                            Tp='<?=$Tp?>';
                            TipoTour = '<?=$TipoTour?>';
                            oTable = $("#brain_datatables<?=$Tp?>").dataTable({
                                    "bProcessing": true,
                                    "bServerSide": true,
                                    
                                    "sAjaxSource": "/protected/modules/rt_biglietto/biglietto_action.php?do=getCorseOpt&ComunePartenzaId="+ComunePartenzaId+"&ComuneDestinazioneId="+ComuneDestinazioneId+"&Tp="+Tp+"&DataFiltroA="+DataFiltroA+"&DataFiltroR="+DataFiltroR+"&Corsaid="+CorsaId+"&DataCorsa="+DataCorsa+"&TipoTour="+TipoTour,                                    
                                    "aoColumns": [
			...
			//"sInfoFiltered": "(risultati totali: _MAX_)"
                 ...
                 $('#brain_datatables<?=$Tp?> tbody td a img.brain_collapse').live( 'click', function () {
