...
function show_list() {
	...
	$HtmlCommon->html_titolo_pagina($dizionario['biglietto']['realmente_prenotati_su_corsa'],0,"","");
	$HtmlCommon->html_titolo_box($dizionario['biglietto']['realmente_prenotati_su_corsa']);
	$db= new Database();
	$db->connect();
	...
	include_once("biglietto_datatable_realmente_prenotati.php");
