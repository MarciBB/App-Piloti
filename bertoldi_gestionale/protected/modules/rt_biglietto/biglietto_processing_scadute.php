...
if (($user->GestoreId!=1) and ($user->GestoreId!=2))
        {
	        if ($sWhere=="")
	            $sWhere =" where GestoreIdRef IN ($InGestoreFigli) AND PrenotazioneStatoId = 14";
	            
	        else
	            $sWhere.=" and GestoreIdRef IN ($InGestoreFigli) AND PrenotazioneStatoId = 14";
	        }
		else {
        	if ($sWhere=="")
            	$sWhere="where PrenotazioneStatoId = 14";
        	else 
        		$sWhere.=" and PrenotazioneStatoId = 14";
        }
