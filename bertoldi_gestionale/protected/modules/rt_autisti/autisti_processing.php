...
$ModuloId=1;
$aColumns = array('Stato', 'Cognome', 'Nome', 'Telefono', 'Cellulare', 'Email', 'AutistiId');
$sIndexColumn = "AutistiId";
$sTable = "RT_ElencoAutisti";
	...
	*/
	...
	while ( $aRow = $db->fetch_array( $rResult ) ) {
		...
		for ( $i=0 ; $i<count($aColumns) ; $i++ ) {
			...
			} elseif ( $aColumns[$i] == "AutistiId") {
				
				$AutistiId=$aRow[ $aColumns[$i] ];
				/* General output */
				$row[] = "<a href=\"#\" onclick=\"loadMainContent('rt_autisti','autisti.php?do=edit&amp;AutistiId=".$AutistiId."',this);\" title=\"edita\"><i class=\"fa fa-pencil-square-o edita\" aria-hidden=\"true\" alt=\"edita\" title=\"edita\"></i></a>";
				$row[] = "<a href=\"#\" onclick=\"loadMainContent('rt_autisti','autisti.php?do=editAccount&amp;AutistiId=".$AutistiId."',this);\" title=\"edita account\"><i class=\"fa fa-pencil-square-o edita\" aria-hidden=\"true\" alt=\"edita\" title=\"edita\"></i></a>";
			} elseif ( $aColumns[$i] != '' ) {
				/* General output */
				$row[] = $aRow[ $aColumns[$i] ];
			}
