...
<style type="text/css" title="currentStyle">
		...
		<!--<script type="text/javascript" language="javascript" src="/DataTables/media/js/jquery.dataTables.js"></script>-->
			...
			$(document).ready(function() {
                        ...
                        if ($("#fieldtoupdate").val()=='ComuneResidenzaId')
                        nazione=$("#StatoResidenzaId").val();
                        if ($("#fieldtoupdate").val()=='ComuneNascitaId')
                        nazione=$("#StatoNascitaId").val();    
                            
                          
                            
                            /* Init the table */
                            oTable = $("#brain_datatables_nazione").dataTable({
                                    "bProcessing": true,
                                    "bServerSide": true,
                                    "sAjaxSource": "/protected/modules/nazione/nazione_processing_cerca.php",
                                    "aoColumns": [
                                    null
			...
			//"sInfoFiltered": "(risultati totali: _MAX_)"
                        ...
                        "aaSorting": [],
                            "fnInitComplete": function () {
                                      ...
                                      //var bottone_aggiungi='<div class="brain_servicebar"><a class="brain_aggiungi" href="javascript:void(0);" onclick="loadMainContent(\'anagrafica\',\'anagrafica.php?do=add\',this);" title="Crea Anagrafica">aggiungi anagrafica</a></div> ';                          
