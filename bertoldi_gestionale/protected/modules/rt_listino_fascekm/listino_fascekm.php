...
include_once("listino_fascekm_validator.php");       
$HtmlCommon->html_titolo_pagina($dizionario['listino']['titolo_aggiungi_km'],0,"rt_listino_fascekm,","listino_fascekm.php");

$HtmlCommon->html_titolo_box($dizionario['listino']['titolo_aggiungi_km']);  
...
<div id="brain_form_content" class="brain_row brain_contenuto">
		<div class="brain_boxIntero">
                ...
                $page->create_textbox($dizionario['listino']['km_da'],"KmDa","ListinoMoltiplicatore[KmDa]","",1,"brain_campoForm campiformBig",array("class"=>"'required number'"));           
                
                print("<br style=\"clear:both;\"/>");
                 
                $page->create_textbox($dizionario['listino']['km_a'],"KmA","ListinoMoltiplicatore[KmA]","",1,"brain_campoForm campiformBig",array("class"=>"'required number'")); 
                
                print("<br style=\"clear:both;\"/>");
               
                $page->create_textbox($dizionario['listino']['moltiplicatore'],"Moltiplicatore","ListinoMoltiplicatore[Moltiplicatore]","",1,"brain_campoForm campiformBig",array("class"=>"'required number'")); 
...
$HtmlCommon->html_titolo_pagina($dizionario['listino']['titolo_edit_km'],0,"rt_listino_fascekm,","listino_fascekm.php");
$HtmlCommon->html_titolo_box ($dizionario['listino']['titolo_edit_km']." - ".$arrFermata['ListinoMoltiplicatore']);
...
<div id="elenco_comuni"></div>
    ...
    print("<br style=\"clear:both;\"/>");
                ...
                $page->create_textbox($dizionario['listino']['km_da'],"KmDa","ListinoMoltiplicatore[KmDa]",$arrListino['KmDa'],1,"brain_campoForm campiformBig",array("class"=>"'required number'"));
               
                print("<br style=\"clear:both;\"/>");
               
                $page->create_textbox($dizionario['listino']['km_a'],"","ListinoMoltiplicatore[KmA]",$arrListino['KmA'],1,"brain_campoForm campiformBig",array("class"=>"'required number'")); 
                
                print("<br style=\"clear:both;\"/>");
               
                $page->create_textbox($dizionario['listino']['moltiplicatore'],"Moltiplicatore","ListinoMoltiplicatore[Moltiplicatore]",$arrListino['Moltiplicatore'],1,"brain_campoForm campiformBig",array("class"=>"'required number'"));     
