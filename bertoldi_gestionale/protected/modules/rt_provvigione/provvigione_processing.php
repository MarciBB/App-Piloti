...
$ModuloId=1;
$aColumns = array('Stato','ProfiloProvvigionaleNome','ProfiloProvvigionalePeso','ProfiloProvvigionaleId' );
$sIndexColumn = "ProfiloProvvigionaleId";
$sTable = "RT_ProfiloProvvigionale";
	...
	*/
	...
	while ( $aRow = $db->fetch_array( $rResult ) )
	{
		...
		for ( $i=0 ; $i<count($aColumns) ; $i++ )
		{
			...
			elseif ( $aColumns[$i] == "ProfiloProvvigionaleId")
			{
                            $ProfiloProvvigionaleId=$aRow[ $aColumns[$i] ];
				/* General output */
                                $row[] = "<a href=\"#\" onclick=\"loadMainContent('rt_provvigione','provvigione.php?do=edit&amp;ProvvigioneId=".$ProfiloProvvigionaleId."',this);\" title=\"edita\"><i class=\"fa fa-pencil-square-o edita\" aria-hidden=\"true\" alt=\"edita\" title=\"edita\"></i></a>";
			}
