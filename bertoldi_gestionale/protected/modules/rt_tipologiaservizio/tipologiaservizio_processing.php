...
$ModuloId=1;
$aColumns = array('Stato','TipologiaServizio','TipologiaServizioDescr','TipologiaServizioPeso','TipologiaServizioId');
$sIndexColumn = "TipologiaServizioId";
$sTable = "RT_ElencoTipologiaServizio";
	...
	*/
	...
	while ( $aRow = $db->fetch_array( $rResult ) )
	{
		...
		for ( $i=0 ; $i<count($aColumns) ; $i++ )
		{
			...
			elseif ( $aColumns[$i] == "TipologiaServizioId")
			{
                            $TipologiaServizioId=$aRow[ $aColumns[$i] ];
				/* General output */
                                $row[] = "<a href=\"#\" onclick=\"loadMainContent('rt_tipologiaservizio','tipologiaservizio.php?do=edit&amp;TipologiaServizioId=".$TipologiaServizioId."',this);\" title=\"edita\"><i class=\"fa fa-pencil-square-o edita\" aria-hidden=\"true\" alt=\"edita\" title=\"edita\"></i></a>";
			}
