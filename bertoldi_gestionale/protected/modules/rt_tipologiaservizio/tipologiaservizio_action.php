...
$data=$_POST['TipologiaServizio'];
$data=$storico->operazioni_insert($data,$user);


$lastidA=$db->insert("RT_TipologiaServizio", $data);
if ($lastidA!=false)
{
...
$result=$db->update("RT_TipologiaServizio", $data, "TipologiaServizioId=".$id." and OdcIdRef=$user->OdcId");
