...
<script type="text/javascript"> 
      ...
      function SetNonViaggiato(Stato,PrenotazioneId,Nome)
    {
        
         descr_stato="Viaggiata";
         if (Stato==1)
             descr_stato="NON Viaggiata";
        stringa="Sei sicuro di voler impostare la prenotazione a nome di "+Nome+" come "+descr_stato;
        ...
        if (conferma)
       {
           page_to_load="/protected/modules/rt_postviaggio/postviaggio_action.php?do=SetViaggiato&Stato="+Stato+"&PrenotazioneId="+PrenotazioneId;
       $.get(page_to_load, function(data){
           
          
           alert("La prenotazione a Nome di "+Nome +" è impostata come "+descr_stato);
           
               avviso_operazione("ok");
               //loadMainContent('rt_postviaggio','postviaggio.php',this);
