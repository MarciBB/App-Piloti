...
include_once("listino_classe_validator.php");       
 $HtmlCommon->html_titolo_pagina($dizionario['listino']['titolo_aggiungi_classe'],0,"rt_listino_classe","listino_classe.php");

$HtmlCommon->html_titolo_box($dizionario['listino']['titolo_aggiungi_classe']);  
