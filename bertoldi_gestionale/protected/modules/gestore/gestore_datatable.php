...
<script type="text/javascript" charset="utf-8">                    
    ...
    (function($) {
        ...
        $.fn.dataTableExt.oApi.fnGetColumnData = function ( oSettings, iColumn, bUnique, bFiltered, bIgnoreEmpty ) {
            ...
            function fnCreateSelectAttivo( aData )
            {
                    var r='<select><option value=""><?=$dizionario['generale']['tutti']?></option>', i, iLen=aData.length;
					
                    r += '<option value="1"><?php echo $dizionario['generale']['attivo'];?></option>';
                    r += '<option value="0"><?php echo $dizionario['generale']['disattivo'];?></option>'; 
			...
			$(document).ready(function() {                         
                            ...
                            oTable = $("#brain_datatables").dataTable({
                                    "bProcessing": true,
                                    "bServerSide": true,
                                    "sAjaxSource": "/protected/modules/gestore/gestore_processing.php",                                    
                                     "aoColumns": [
                                    { "sClass": "center" },
                                    null,
                                    null,
                        ...
                        "aaSorting": [],
                            "fnInitComplete": function () {
                                         ...
                                         $("thead th span").each( function (i) {
                                            ...
                                            this.innerHTML = fnCreateSelectAttivo( oTable.fnGetColumnData(i) );
