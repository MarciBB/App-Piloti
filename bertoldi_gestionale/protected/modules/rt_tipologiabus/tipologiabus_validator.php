...
function loadMediazioneStep(modulo,page,elem)
    ...
    function submit_form_tipologiabus()
    {
        ...
        $.ajax({
           type: "POST",
           url: "/protected/modules/rt_tipologiabus/tipologiabus_action.php",
           ...
           success: function(msg) {
              ...
              if(msg.indexOf(',')>-1)
              {
                 ...
                 if (step_successivo=='0')
                      loadMainContent('rt_tipologiabus','tipologiabus.php?do=edit&Idtipologiabus=0',this);
                  else
                   loadMainContent1('rt_tipologiabus','tipologiabus.php?do=add&step='+step_successivo,this);
