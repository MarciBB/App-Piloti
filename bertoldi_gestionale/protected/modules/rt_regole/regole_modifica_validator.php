...
function loadMediazioneStep(modulo,page,elem)
    ...
    function submit_form_provvigione()
    {
        ...
        $.ajax({
           type: "POST",
           url: "/protected/modules/rt_regole/regole_modifica_action.php",
           ...
           success: function(msg) {
              ...
              if(msg.indexOf(',')>-1)
              {
                 ...
                 if (step_successivo=='0')
                      loadMainContent('rt_regole','regole_modifica.php?do=edit&Idprovvigione=0',this);
                  else
                   loadMainContent1('rt_regole','regole_modifica.php?do=add&step='+step_successivo,this);
