...
include_once("stat_venduto_provvigioni_validator.php");  
...
<?
    $page->create_select($dizionario['generale']['agenzia'].":","GestoreId","GestoreId","rowForm",$arr_gestore,$gestorecorrente,"GestoreId","RagioneSociale",
    array("onChange"=>"'javascript:getSediByGestore(this);'"
                                                   ),1);
 
 
    $page->create_select($dizionario['conto']['rivendita'].":","SedeId","SedeId","rowForm",$arr_sedi,$user->SedeId,"SedeId","Sede",
                                             null,1);
