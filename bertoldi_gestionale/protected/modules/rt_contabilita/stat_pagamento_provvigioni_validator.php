        ...
        function getSediByGestore(oggetto)
{
    ...
    if(GestoreId == '-1' || GestoreId == '-2'){
      $("#SedeId").html("<option>- seleziona -</option>");
      return;
    }
    page_to_load="/protected/modules/sede/sede_service.php?do=getSediByGestore&GestoreId="+GestoreId;
            //	$("#layer_nero2").toggle();
...
<script type="text/javascript"> 
   ...
   $(document).ready(function() {
    ...
    function submit_form_statistiche()
    {
        ...
        $.ajax({
           type: "POST",
           url: "/protected/modules/rt_contabilita/stat_pagamento_provvigioni_processing.php",
