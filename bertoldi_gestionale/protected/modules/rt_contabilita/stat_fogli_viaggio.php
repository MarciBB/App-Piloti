...
$arr_pagamenti = array(
    array('PagamentoId'=>'pos', 'Pagamento'=>$dizionario['stampe']['pos']),
    array('PagamentoId'=>'contanti', 'Pagamento'=>$dizionario['stampe']['contanti']),
);
...
include_once("stat_fogli_viaggio_validator.php");  
...
<!--inizio riga per i filtri--->		
	<div class="brainFiltri">
		...
		<?
    	$page->create_select($dizionario['stampe']['pagamento'].":","PagamentoId","PagamentoId","rowForm",$arr_pagamenti,0,"PagamentoId","Pagamento", null,1);
		?>
	    	<div class="rowForm">
