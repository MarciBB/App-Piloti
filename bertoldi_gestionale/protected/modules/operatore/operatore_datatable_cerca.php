		...
		<!--<script type="text/javascript" language="javascript" src="/DataTables/media/js/jquery.dataTables.js"></script>-->
			...
			$(document).ready(function() {
                            ...
                            oTable = $("#brain_datatables").dataTable({
                                    "bProcessing": true,
                                    "bServerSide": true,
                                    "sAjaxSource": "/protected/modules/operatore/operatore_processing_cerca.php",
			...
			//"sInfoFiltered": "(risultati totali: _MAX_)"
                        ...
                        "aaSorting": [[2, 'asc']],
                            "fnInitComplete": function () {
                                      ...
                                      var bottone_aggiungi='<div class="brain_servicebar"><a class="brain_aggiungi" href="javascript:void(0);" onclick="loadMainContent(\'operatore\',\'operatore.php?do=add\',this);" title="Crea operatore"><?=$dizionario['operatore']['aggiungi_operatore']?></a></div> ';                          
