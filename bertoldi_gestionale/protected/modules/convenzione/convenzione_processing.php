...
$ModuloId=27;
$aColumns = array('Convenzione','AppConvenzioneTipo','AppConvenzioneTipoDescrizione','ConvenzioneId');
$sIndexColumn = "ConvenzioneId";
$sTable = "ElencoConvenzioniView";
	...
	*/
	...
	while ( $aRow = $db->fetch_array( $rResult ) )
	{
		...
		for ( $i=0 ; $i<count($aColumns) ; $i++ )
		{
			...
			if ( $aColumns[$i] == "ConvenzioneId")
			{
                            $ConvenzioneId=$aRow[ $aColumns[$i] ];
				/* General output */
                                $row[] = "<a href=\"javascript:void(0);\" onclick=\"loadMainContent('convenzione','convenzione.php?do=edit&amp;ConvenzioneId=".$ConvenzioneId."',this);\" title=\"edita\"><i class=\"fa fa-pencil-square-o edita\" aria-hidden=\"true\" alt=\"edita\" title=\"edita\"></i></a>";
