...
function loadMediazioneStep(modulo,page,elem)
    ...
    function submit_form_convenzione()
    {
        ...
        $.ajax({
           type: "POST",
           url: "/protected/modules/convenzione/convenzione_action.php",
           data: $("#application_form").serialize(),
           success: function(msg) {
                     avviso_operazione("ok");
                     if (step_successivo=='0')
                         loadMainContent('convenzione','convenzione.php',this);
                     else
                     loadMainContent('convenzione','convenzione.php?do=add&step='+step_successivo,this);
            } // end success
