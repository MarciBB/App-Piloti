...
$ModuloId=1;
$aColumns = array('Odc','NumeroAutorizzazione','OdcId');
$sIndexColumn = "OdcId";
$sTable = "Odc";
	...
	while ( $aRow = $db->fetch_array( $rResult ) )
	{
		...
		for ( $i=0 ; $i<count($aColumns) ; $i++ )
		{
			...
			if ( $aColumns[$i] == "OdcId")
			{
				...
				/* General output */
                                $row[] = "<a href=\"javascript:void(0);\" onclick=\"loadMainContent('organismo','organismo.php?do=edit&amp;OrganismoId=".$OdcId."',this);\" title=\"edita\"><i class=\"fa fa-pencil-square-o edita\" aria-hidden=\"true\" alt=\"edita\" title=\"edita\"></i></a>";
