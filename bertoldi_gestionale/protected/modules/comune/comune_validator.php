...
<script type="text/javascript"> 
    ...
    function submit_form()
    {
        ...
        $.ajax({
           type: "POST",
           url: "/protected/modules/comune/comune_action.php",
           ...
           success: function(msg) {
              ...
              if(msg.indexOf(',')>-1)
              {
                ...
                {
                loadMainContent('comune','comune.php',this);
                avviso_operazione(messaggio);
                }
                else
                {
                    AddAnagraficaParteIntoMediazione(id);
    ...
    function getProvincia(ElementId)
    {  
    if ((ElementId!=0)&&(ElementId!=""))
        {       
     page_to_load="/protected/modules/provincia/provincia.php?do=get_provincia_camping&RegioneId="+ElementId;
            //	$("#layer_nero2").toggle();
            $.get(page_to_load, function(data){
                    $("#Provincia").html(data);                   
