...
$data=$_POST['TipologiaBiglietto'];
$data=$storico->operazioni_insert($data,$user);


$lastidA=$db->insert("RT_TipologiaBiglietto", $data);
if ($lastidA!=false)
{
...
$result=$db->update("RT_TipologiaBiglietto", $data, "TipologiaBigliettoId=".$id." and OdcIdRef=$user->OdcId");
