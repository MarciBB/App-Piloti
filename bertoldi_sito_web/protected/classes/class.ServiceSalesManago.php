...
class ServiceSalesManago  {
	...
	public function sendEvent($prenotazioneId, $eventType, $email, $products, $importo, $lang = null, $tour = null, $esperienza = null, $phone = null, $name = null, $country = null, $desctiption = null, $from = null, $consentDetails = null)
    {
        ...
        if ($consentDetails && is_array($consentDetails)) {
            $contactPayload['consentDetails'] = $consentDetails;
            if($consentDetails[1]['consentAccept'] || $consentDetails[1]['consentAccept'] == 1 || $consentDetails[1]['consentAccept'] == 'true') {
                $contactPayload['contact']['emailOptIn'] = 1;
                $contactPayload['contact']['mobileOptIn'] = 1;
                $contactPayload['forceOptIn'] = true;
                $contactPayload['forceOptOut'] = false;
                $contactPayload['forcePhoneOptIn'] = true;
                $contactPayload['forcePhoneOptOut'] = false;
            } else {
                $contactPayload['contact']['emailOptIn'] = -1;
                $contactPayload['contact']['mobileOptIn'] = -1;
                $contactPayload['forceOptIn'] = false;
                $contactPayload['forceOptOut'] = true;
                $contactPayload['forcePhoneOptIn'] = false;
                $contactPayload['forcePhoneOptOut'] = true;
            }
        }
