...
class LineaGraph {
	...
	public $flotta;
	public $postiBus;
	function __construct($idLinea, $idCorsa, $conn, $partenza=null, $destinazione=null) {
...
// 			echo $sql;
			...
			if(count($row)!=0){
				$sql = "SELECT distinct FermataIdDrop,FermataOrarioDrop,TrattaNome From RT_ElencoFermataOrarioDO WHERE Stato=1 and Cancella=0 and  IsDropOff=1 and  CorsaId=".$this->idCorsa." and ComuneId=$dropoff and TrattaId=".$row[0]['TrattaId']."  and TrattaStato=1 order by TrattaPeso asc";
